...
//			AddAlarmFunc: func(ctx context.Context, deviceID string, alarm m.Alarm) error {
...
//			},
//			GetAlarmsFunc: func(ctx context.Context, onlyActive bool) ([]m.Alarm, error) {
//				panic("mock out the GetAlarms method")
//			},
//			GetDeviceByDeviceIDFunc: func(ctx context.Context, deviceID string, tenants ...string) (m.Device, error) {
//				panic("mock out the GetDeviceByDeviceID method")
//			},
//			GetDeviceBySensorIDFunc: func(ctx context.Context, sensorID string, tenants ...string) (m.Device, error) {
//				panic("mock out the GetDeviceBySensorID method")
//			},
//			GetDevicesFunc: func(ctx context.Context, tenants ...string) ([]m.Device, error) {
...
//			},
//			UpdateDeviceStateFunc: func(ctx context.Context, deviceID string, deviceState m.DeviceState) error {
//				panic("mock out the UpdateDeviceState method")
//			},
//			UpdateDeviceStatusFunc: func(ctx context.Context, deviceID string, deviceStatus m.DeviceStatus) error {
...
func (mock *DeviceManagementMock) AddAlarm(ctx context.Context, deviceID string, alarm m.Alarm) error {
...
func (mock *DeviceManagementMock) GetAlarms(ctx context.Context, onlyActive bool) ([]m.Alarm, error) {
	if mock.GetAlarmsFunc == nil {
		panic("DeviceManagementMock.GetAlarmsFunc: method is nil but DeviceManagement.GetAlarms was just called")
	}
	callInfo := struct {
		Ctx        context.Context
		OnlyActive bool
...
// Check the length with:
//
//	len(mockedDeviceManagement.GetAlarmsCalls())
func (mock *DeviceManagementMock) GetAlarmsCalls() []struct {
	Ctx        context.Context
	OnlyActive bool
} {
	var calls []struct {
...
func (mock *DeviceManagementMock) GetDeviceByDeviceID(ctx context.Context, deviceID string, tenants ...string) (m.Device, error) {
...
func (mock *DeviceManagementMock) GetDeviceBySensorID(ctx context.Context, sensorID string, tenants ...string) (m.Device, error) {
...
func (mock *DeviceManagementMock) GetDevices(ctx context.Context, tenants ...string) ([]m.Device, error) {
...
func (mock *DeviceManagementMock) UpdateDeviceState(ctx context.Context, deviceID string, deviceState m.DeviceState) error {
...
func (mock *DeviceManagementMock) UpdateDeviceStatus(ctx context.Context, deviceID string, deviceStatus m.DeviceStatus) error {
