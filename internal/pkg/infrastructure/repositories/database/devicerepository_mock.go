...
//			},
//			GetDeviceIDFunc: func(ctx context.Context, sensorID string) (string, error) {
...
//			},
//			SeedFunc: func(contextMoqParam context.Context, s string, reader io.Reader) error {
//				panic("mock out the Seed method")
//			},
//			UpdateDeviceStateFunc: func(ctx context.Context, deviceID string, deviceState models.DeviceState) error {
//				panic("mock out the UpdateDeviceState method")
//			},
//			UpdateDeviceStatusFunc: func(ctx context.Context, deviceID string, deviceStatus models.DeviceStatus) error {
...
func (mock *DeviceRepositoryMock) GetDeviceID(ctx context.Context, sensorID string) (string, error) {
	if mock.GetDeviceIDFunc == nil {
		panic("DeviceRepositoryMock.GetDeviceIDFunc: method is nil but DeviceRepository.GetDeviceID was just called")
	}
	callInfo := struct {
		Ctx      context.Context
		SensorID string
	...
	return mock.GetDeviceIDFunc(ctx, sensorID)
}

// GetDeviceIDCalls gets all the calls that were made to GetDeviceID.
// Check the length with:
//
//	len(mockedDeviceRepository.GetDeviceIDCalls())
func (mock *DeviceRepositoryMock) GetDeviceIDCalls() []struct {
	Ctx      context.Context
	SensorID string
} {
	var calls []struct {
...
func (mock *DeviceRepositoryMock) GetDevices(ctx context.Context, tenants ...string) ([]models.Device, error) {
...
// Seed calls SeedFunc.
func (mock *DeviceRepositoryMock) Seed(contextMoqParam context.Context, s string, reader io.Reader) error {
	...
	return mock.SeedFunc(contextMoqParam, s, reader)
}
...
func (mock *DeviceRepositoryMock) UpdateDeviceState(ctx context.Context, deviceID string, deviceState models.DeviceState) error {
...
func (mock *DeviceRepositoryMock) UpdateDeviceStatus(ctx context.Context, deviceID string, deviceStatus models.DeviceStatus) error {
